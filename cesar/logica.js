...
function cifrar(){
    const desplazamiento=document.getElementById('numero').value;
    console.log(desplazamiento);    
    document.getElementById("resultado").innerHTML =
    cesar.encode(document.getElementById("cadena").value, Number(desplazamiento));
}
...
function descifrar(){
    ...
    console.log(desplazamiento);
    document.getElementById("resultado").innerHTML =
    cesar.decode(document.getElementById("cadena").value, Number(desplazamiento));
}
